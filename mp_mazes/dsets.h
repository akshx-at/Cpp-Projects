...
class DisjointSets
{
  public:
     ...
     */
     // so addelements focuses on creeating an a vector of size number that is being passed in and setting all the values to -1 initially
     ...
     */
    int size(int elem);
// We created a struct to keep in track of the left and right value of each node and its value 
//     struct Node {
//     int value;
//     Node* left;
//     Node* right;
